...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 11 23:42:19 2021
...
all_img = []
all_masks = []
for i in range(860, NUM_IMAGES+860):
    
    image_path = f'/Users/liamrussell17/Desktop/Fall Quarter Lab Rotation/Segmenting Neural Network/Test Images/Gaussian_Filter_Images/image{i}.png'
    image = cv2.imread(image_path, 0)
    image = np.asarray(image)
    all_img.append(image)
    mask_path = f'/Users/liamrussell17/Desktop/Fall Quarter Lab Rotation/Segmenting Neural Network/Test Images/masks/mask{i}.png'
...
checkpoint_path = '/Users/liamrussell17/Desktop/Fall Quarter Lab Rotation/Segmenting Neural Network/saved_model/saved_model_3.ckpt'
...
history = model.fit_generator(my_generator, validation_data=validation_datagen, 
                    ...
                    validation_steps=steps_per_epoch, callbacks=[cp_callback], epochs=NUM_EPOCHS)
